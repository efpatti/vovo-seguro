...
function meuDark() {
    ...
    let element = document.getElementById("navVovozao");
    ...
    let carac1 = document.getElementById("c1");
    carac1.classList.toggle("ocult");
    let carac2 = document.getElementById("c2");
    carac2.classList.toggle("vis");
  }
  function escondeB() {
    document.getElementById("botaoF").style.visibility = "visible";
    document.getElementById("botaoA").style.visibility = "visible";
  }
  setTimeout(escondeB, 15000);
